...
function App() {
    ...
    const [GameOver, setGameOver] = useState({isGameOver: false, message: "Game Over"})
    ...
    return (
        <div className="app">
            <div className='app-container'>   
                ...
                />
                <p className='htp'>
                    <span>How to play:</span> Use your arrow keys to move the tiles. Tiles with the same number merge into one when they touch. Add them up to reach 2048!
                </p>
            </div>
        </div>
    )
